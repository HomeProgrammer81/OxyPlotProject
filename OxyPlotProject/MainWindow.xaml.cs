...
namespace OxyPlotProject
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private readonly ObservableCollection<Tuple<string, string>> IdNames = new ObservableCollection<Tuple<string, string>>()
        {
            ...
            new Tuple<string, string>("bar", "棒グラフ"),
            new Tuple<string, string>("barlineup", "棒グラフ-並べて"),
            new Tuple<string, string>("barstack", "棒グラフ-積み重ね"),
            new Tuple<string, string>("baroverwrite", "棒グラフ-重ねる"),
        ...
        private readonly Dictionary<string, AbstPlotModelFactory> PlotModelFactoryTable = new Dictionary<string, AbstPlotModelFactory>()
        {
            ...
            {"bar", new BarPlotModelFactory() },
            {"barlineup", new LineUpBarPlotModelFactory() },
            {"barstack", new StackBarPlotModelFactory() },
            {"baroverwrite", new BarOverWritePlotModelFactory() },
